<%@ Page Title="" Language="C#" MasterPageFile="~/Salitex.Master" AutoEventWireup="true" CodeBehind="StockDetailMovement.aspx.cs" Inherits="Reporting_Portal.StockDetailMovement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="card card-primary card-outline" style="border-top: 3px solid #875a7b !important">
        <div class="card-body">
            ...
            <br />
            <CR:CrystalReportViewer ID="Stock_Movement_Report" runat="server" AutoDataBind="true" ToolPanelView="None" />
        </div>
    </div>
</asp:Content>